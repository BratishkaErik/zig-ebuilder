...
fn prepare(
    ...
    // Synced with Zig build runner, version 0.15.0-dev.246+0cd31fc7f .
    if (true) return zig_ebuilder_section: {
        ...
        var user_options: std.ArrayListUnmanaged(Report.UserOption) = .empty;
        ...
        var system_libraries_list: std.ArrayListUnmanaged(Report.SystemLibrary) = .empty;
